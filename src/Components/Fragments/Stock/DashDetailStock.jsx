      ...
      <div className="max-w-6xl w-full mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Informasi lengkap stok obat {stock.medicine?.name}
                </p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 min-h-[500px]">
            {/* Left Side - Stock Display */}
            <div className="lg:col-span-2 bg-gray-50 p-8 flex items-center justify-center border-r border-gray-200">
              <div className="relative text-center">
                <div className="w-64 h-64 rounded-2xl bg-primary flex flex-col items-center justify-center border-4 border-white shadow-xl">
                  <TrendingUp className="h-16 w-16 text-white mb-4" />
                ...
                <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2">
                  <span
                    className={`inline-flex items-center px-3 py-1 text-sm font-medium rounded-full border ${stockStatus.color}`}
                  >
                ...
                <div className="space-y-8">
                  ...
                  <div className="pb-6 border-b border-gray-200">
                    ...
                    <p className="text-gray-600 mt-2">
                      Detail lengkap informasi stok obat
                    </p>
                  </div>
