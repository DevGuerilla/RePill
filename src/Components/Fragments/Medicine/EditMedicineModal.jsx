...
const EditMedicineModal = ({ isOpen, onClose, onSuccess, medicine }) => {
  ...
  const handleSuccess = () => {
    ...
    setResponseMessage(
      "Obat berhasil diperbarui! Data akan diperbarui secara otomatis."
    );
  ...
  const handleError = (error) => {
    ...
    setResponseMessage(
      error || "Terjadi kesalahan saat memperbarui obat. Silakan coba lagi."
    );
    setShowResponseModal(true);
  };
