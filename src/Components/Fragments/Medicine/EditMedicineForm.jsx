...
const EditMedicineForm = ({
  ...
  const { updateMedicine, loading, errors, message, success } =
    useEditMedicine();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await updateMedicine(medicine.uuid, formData);
      ...
      console.error("EditMedicineForm: Error submitting form:", error);
    }
  };
