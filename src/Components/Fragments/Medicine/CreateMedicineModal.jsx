...
const CreateMedicineModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSuccess = () => {
    ...
    setResponseMessage(
      "Obat baru berhasil dibuat! Data akan diperbarui secara otomatis."
    );
  ...
  const handleError = (error) => {
    ...
    setResponseMessage(
      error || "Terjadi kesalahan saat membuat obat. Silakan coba lagi."
    );
    setShowResponseModal(true);
  };
